...
AS
    ...
    PROCEDURE GET_ABONO (USER_ID IN NUMBER,GRUPO VARCHAR2,  OUT_ABONO OUT SYS_REFCURSOR);
    FUNCTION GET_GRUPO(USER_ID IN NUMBER) RETURN NUMBER;
    PROCEDURE GET_PAGO (USER_ID IN NUMBER,GRUPO VARCHAR2, OUT_PAGO OUT SYS_REFCURSOR);
    PROCEDURE GET_TIPO_PAGO(OUT_TIPO_PAGO OUT SYS_REFCURSOR);
    PROCEDURE GET_TRATAMIENTO_PACIENTE(OUT_TRATAMIENTO OUT SYS_REFCURSOR, ID_PACIENTE_V IN NUMBER);
END GET_PKG;
/