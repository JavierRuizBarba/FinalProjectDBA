...
AS
    ...
    AS
    BEGIN
        UPDATE DIENTES.CITA CITAS SET CITAS.ACEPTADA=1 WHERE CITAS.ID_CITA=ID_CITA_V;
    END EDIT_CITA_ACEPTAR;
    ...
    BEGIN
        ...
        UPDATE DIENTES.USUARIOS SECUNDARIO
           SET SECUNDARIO.CELULAR = CELL,
               SECUNDARIO.SEXO = GENERO,
               SECUNDARIO.TIPO_SANGRE = BLOOD
         WHERE SECUNDARIO.ID_USUARIO = USUARIOID;
    END EDIT_USER_INFO;

    PROCEDURE EDIT_USER_GROUP (USUARIOGRUPOID IN NUMBER, GRUPOID IN NUMBER)
    AS
    BEGIN
        UPDATE dientes.auth_user_groups usergroups
           SET usergroups.GROUP_ID = grupoid
         WHERE usergroups.ID = usuariogrupoid;
    END;
END EDIT_PKG;
/
